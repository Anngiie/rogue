<?php
/**
 * Single related posts override for Viberi.
 * Adds a placeholder when a related post has no featured image.
 *
...
if ( $oceanwp_related_query->have_posts() ) :
	...
	<section id="related-posts" class="<?php echo esc_attr( $classes ); ?>" aria-label="<?php echo esc_attr__( 'Možda će vas zanimati', 'oceanwp-child' ); ?>">

		<<?php echo esc_attr( $heading_tag ); ?> class="theme-heading related-posts-title">
			<span class="text"><?php esc_html_e( 'Možda će vas zanimati', 'oceanwp-child' ); ?></span>
