...
function vk_child_enqueue_styles() {
	...
	wp_enqueue_style(
		'vk-google-fonts',
		'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Newsreader:ital,opsz,wght@0,6..72,400;0,6..72,500;0,6..72,600;0,6..72,700;1,6..72,400;1,6..72,500&display=swap',
		array(),
		null
	);
...
/**
 * 2) System font override — make Inter the body font and Newsreader the display serif.
 */
...
function vk_headings_font_family() {
	return "'Newsreader', Georgia, 'Times New Roman', serif";
}
